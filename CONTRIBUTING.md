...
Welcome to `ai-lab` contributor's guide.
...
If you experience bugs or general issues with `ai-lab`, please have a look
...
You can help improve `ai-lab` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`ai-lab` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `ai-lab`'s files. While this mechanism can
...
```
conda create -n ai-lab python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/ai-lab.git
   cd ai-lab
   ```
...
5. Install [pre-commit]:
   ...
   `ai-lab` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/ai-lab
[issue tracker]: https://github.com/<USERNAME>/ai-lab/issues
