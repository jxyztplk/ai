...
Welcome to `ai_labs` contributor's guide.
...
If you experience bugs or general issues with `ai_labs`, please have a look
...
You can help improve `ai_labs` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`ai_labs` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `ai_labs`'s files. While this mechanism can
...
```
conda create -n ai_labs python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/ai_labs.git
   cd ai_labs
   ```
...
5. Install [pre-commit]:
   ...
   `ai_labs` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/ai_labs
[issue tracker]: https://github.com/<USERNAME>/ai_labs/issues
